...
import com.gyanendra.test.pieces.Bishop;
import com.gyanendra.test.pieces.King;
import com.gyanendra.test.pieces.Knight;
import com.gyanendra.test.pieces.Pawn;
import com.gyanendra.test.pieces.Queen;
import com.gyanendra.test.pieces.Rook;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView = findViewById(R.id.playertext1);
        String myvalue =getIntent().getStringExtra("name");
        textView.setText(myvalue);


        textView1=findViewById(R.id.playertext2);
        String myvalue1 = getIntent().getStringExtra("name1");
        textView1.setText(myvalue1);
